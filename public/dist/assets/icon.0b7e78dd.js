import{r as h,s as o,t as e,v as p,w as i,x as m,y as n,z as d,A as F,C as f,D as E,E as v,F as M}from"./index.01cbc5a3.js";import{g as u,h as B,j as I,k as V}from"./index.ab718934.js";import{ah as t,bX as k,bY as x}from"./index.acf3a792.js";import{I as H}from"./Layout.f1f06452.js";var l=(a=>(a[a.UNKNOWN=0]="UNKNOWN",a[a.FOLDER=1]="FOLDER",a[a.VIDEO=2]="VIDEO",a[a.AUDIO=3]="AUDIO",a[a.TEXT=4]="TEXT",a[a.IMAGE=5]="IMAGE",a))(l||{});function D(a){return t({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#070444"
  ...
  ></path>`},a)}function A(a){return t({a:{viewBox:"0 0 32 32"},c:`<path
    fill="#909090"
  ...
  ></path>F`},a)}const L={"dmg,ipa,plist,tipa":m,"exe,msi":n,"zip,gz,rar,7z,tar,jar,xz":d,apk:H,db:u,md:F,epub:B,iso:I,m3u8:i,"doc,docx":f,"xls,xlsx":E,"ppt,pptx":v,pdf:M,psd:D,ai:A,url:V},Z=(a,c)=>{if(a!==l.FOLDER){for(const[s,r]of Object.entries(L))if(s.split(",").includes(c.toLowerCase()))return r}switch(a){case l.FOLDER:return x;case l.VIDEO:return i;case l.AUDIO:return p;case l.TEXT:return e;case l.IMAGE:return o;default:return h}},S=a=>Z(a.type,k(a.name));export{l as O,S as g};
